...
function floor_with_precision($number, $precision, $separator)
{
    ...
    $parts[1] = substr($parts[1], 0, $precision);
    return $parts[0] . $separator . $parts[1];
}

echo floor_with_precision(1.155, 2, ".") . "<br>";
echo floor_with_precision(100.25781, 4, ".") . "<br>";
echo floor_with_precision(-2.9636, 3, ".") . "<br>";
echo "<br><br>";
//17  ******************************************************************************************************************************************
...
$is_subset = !array_diff($array2, $array1);
